...
public class MissionService {
    ...
    public List<MemberMissionResDTO.GetInfo> getHomeMissions(MissionReqDTO.GetInfo dto, Long missionId, Long locationId, int size) {
    ...
    public List<MissionResDTO.GetInfo> getMemberMissions(MissionReqDTO.GetInfo dto, Long missionId, List<Status> status, int size) {
        Pageable pageable = PageRequest.of(0, size);
